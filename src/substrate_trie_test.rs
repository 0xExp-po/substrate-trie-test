...
use sp_trie::{trie_types::TrieDBMutBuilderV1, LayoutV1, MemoryDB, TrieDBMut, TrieHash, TrieMut};
...
pub fn root() {
    ...
    let mut t: TrieDBMut<'_, LayoutV1<Blake2Hasher>> =
        TrieDBMutBuilderV1::new(&mut db, &mut root).build();
    ...
    let root = &H256(hex![
        "f465577d5a13b1a48ea7245c559ab78175eb509b00829cf5db09d61ea795b74a"
    ]);
